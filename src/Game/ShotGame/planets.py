...
def getSpacePlanet(planet):
  value = [[int(xValue(planet[0])), int(xValue(planet[0] + (xValue(100))))],
          [ int(yValue(planet[1])), int(yValue(planet[1] + (yValue(100))))]]
  return value
